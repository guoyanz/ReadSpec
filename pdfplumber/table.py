...
class TableFinder(object):
    ...
    def get_edges(self):
        ...
        if v_strat == "text" or h_strat == "text":
            ...
            # 注：words:{'x0': Decimal('415.110'), 'x1': Decimal('573.557'), 'top': Decimal('113.976'), 'bottom': Decimal('122.942'), 'upright': 1, 'text': 'C o d e d v a r i a b l e w i t h M e d D R A d i c t i o n a r y'}
        v_explicit = []
